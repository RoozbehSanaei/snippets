...
def sum_array(input_array, jojo):
    return _example.sum_array(input_array, jojo)
sum_array = _example.sum_array

def sum_array2(input_array, input_array2):
    return _example.sum_array2(input_array, input_array2)
sum_array2 = _example.sum_array2

def get_rand_array(output_array):
    return _example.get_rand_array(output_array)
get_rand_array = _example.get_rand_array

def double_list(length, arg):
    return _example.double_list(length, arg)
double_list = _example.double_list

def arrayFunction(npyArray2D):
    return _example.arrayFunction(npyArray2D)
arrayFunction = _example.arrayFunction

def func2(jojo):
    return _example.func2(jojo)
func2 = _example.func2
