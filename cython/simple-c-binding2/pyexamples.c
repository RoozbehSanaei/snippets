...
if (!__Pyx_RefNanny) {
  ...
  #if PY_MAJOR_VERSION >= 3
  {
    ...
    if (!PyDict_GetItemString(modules, "pyexamples")) {
      if (unlikely(PyDict_SetItemString(modules, "pyexamples", __pyx_m) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     hello(name)
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10pyexamples_1py_hello, NULL, __pyx_n_s_pyexamples); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 5, __pyx_L1_error)
