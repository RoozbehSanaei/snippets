...
class VecString(_object):
    ...
    def __getitem__(self, i):
        return _test.VecString___getitem__(self, i)

    def __init__(self):
        this = _test.new_VecString()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _test.delete_VecString
    __del__ = lambda self: None
VecString_swigregister = _test.VecString_swigregister
...
class VecVecString(_object):
    ...
    def __getitem__(self, i):
        return _test.VecVecString___getitem__(self, i)

    def __init__(self):
        this = _test.new_VecVecString()
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _test.delete_VecVecString
    __del__ = lambda self: None
VecVecString_swigregister = _test.VecVecString_swigregister
VecVecString_swigregister(VecVecString)


def print_vec(v):
    return _test.print_vec(v)
print_vec = _test.print_vec

def print_vec_vec(v):
    return _test.print_vec_vec(v)
print_vec_vec = _test.print_vec_vec
