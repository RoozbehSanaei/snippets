...
static PyObject *__pyx_pw_12cy_quicksort_1quicksort_c(PyObject *__pyx_self, PyObject *__pyx_arg_a) {
  ...
  assert(__pyx_arg_a); {
    __pyx_v_a = __Pyx_PyObject_to_MemoryviewSlice_dc_int(__pyx_arg_a, PyBUF_WRITABLE); if (unlikely(!__pyx_v_a.memview)) __PYX_ERR(0, 3, __pyx_L3_error)
  }
 ...
 *     quicksort.quick_sort(&a[0], a.size)
 */
  __pyx_tuple__22 = PyTuple_Pack(2, __pyx_n_s_a, __pyx_n_s_a); if (unlikely(!__pyx_tuple__22)) __PYX_ERR(0, 3, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__22);
  __Pyx_GIVEREF(__pyx_tuple__22);
  __pyx_codeobj__23 = (PyObject*)__Pyx_PyCode_New(1, 0, 2, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__22, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_cy_quicksort_pyx, __pyx_n_s_quicksort_c, 3, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__23)) __PYX_ERR(0, 3, __pyx_L1_error)
